...
def animate_ratation(context, ring_obj, rotation_y, rotation_z):
    degrees = rotation_y
    ...
    degrees = rotation_y + 360
    radians = math.radians(degrees)
    ring_obj.rotation_euler.y = radians

    degrees = rotation_z + 360 * 2
    radians = math.radians(degrees)
    ring_obj.rotation_euler.z = radians
...
def create_centerpiece(context):
    ...
    for i in range(number_of_rings):
        ...
        animate_ratation(context, ring_obj, rotation_y, rotation_z)
        
        rotation_z += rotation_z_step
